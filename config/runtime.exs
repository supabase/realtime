...
connect_throttle_limit_per_minute = System.get_env("CONNECT_THROTTLE_LIMIT_PER_MINUTE", "1") |> String.to_integer()
...
config :realtime,
  ...
  connect_throttle_limit_per_minute: connect_throttle_limit_per_minute,
