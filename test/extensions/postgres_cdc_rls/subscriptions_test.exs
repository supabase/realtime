defmodule Extensions.PostgresCdcRls.SubscriptionsTest do
  ...
  describe "subscribing to table changes" do
    ...
    test "registers the subscription insert in the connection's statement cache", %{conn: conn} do
      ...
      refute "realtime_subscription_insert" in cached_statement_names(conn)
      ...
      assert "realtime_subscription_insert" in cached_statement_names(conn)
    end
