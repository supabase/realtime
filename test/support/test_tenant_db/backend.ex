defmodule TestTenantDb.Backend do
  ...
  # Where to probe for the capabilities the suite's tags gate on - Postgres
  # version, supautils grants, OrioleDB. `:realtime_db` when this backend's
  # tenant databases run the same image as the realtime database, which can
