defmodule Realtime.Integration.RtChannelTest do
  ...
  describe "postgres changes" do
    # NOTE: Test is flaky - fails during setup with GenServer shutdown when run with full test suite.
    # Passes when run individually, suggesting resource contention or timing issues.
  ...
  describe "handle presence extension" do
    ...
    # NOTE: Test is flaky - fails when run with full test suite but passes individually.
    # Likely due to resource contention or timing issues during test setup.
