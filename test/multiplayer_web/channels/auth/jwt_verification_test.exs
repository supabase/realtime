defmodule MultiplayerWeb.JwtVerificationTest do
  use ExUnit.Case

  alias MultiplayerWeb.JwtVerification
  alias MultiplayerWeb.Joken.CurrentTime.Mock

  @jwt_secret "secret"
  @alg "HS256"

  setup_all do
    Application.put_env(:multiplayer, :jwt_secret, @jwt_secret)
    Application.put_env(:multiplayer, :jwt_claim_validators, %{})
  end
