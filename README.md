...
| MAX_GEN_RPC_CLIENTS                             | number  | Max `gen_rpc` TCP connections per node for cast operations (cast, abcast, multicast). Defaults to 5.                                                                                                                                                                                                                            |
| MAX_GEN_RPC_CALL_CLIENTS                        | number  | Max `gen_rpc` TCP connections per node for call operations (call, multicall). Defaults to 1.                                                                                                                                                                                                                                    |
