...
| MAX_CHILDREN_SCHEDULED_CLEANUP | number  | Maximum number of concurrent tasks working on scheduled cleanup                                                                                                                                                                                                                                                                 |
| SCHEDULED_CLEANUP_TASK_TIMEOUT | number  | Timeout for each async task for scheduled cleanup                                                                                                                                                                                                                                                                               |
## WebSocket URL
...
| FailedToDeleteOldMessages          | Scheduled task for realtime.message cleanup was unable to run                                                                       |
