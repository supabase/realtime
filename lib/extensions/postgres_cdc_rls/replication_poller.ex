defmodule Extensions.PostgresCdcRls.ReplicationPoller do
  ...
  def init(args) do
    ...
    %Realtime.Api.Tenant{max_events_per_second: max_events_per_second} =
      Tenants.Cache.get_tenant_by_external_id(tenant_id)

    rate_counter_args = Tenants.db_events_per_second_rate(tenant_id, max_events_per_second)
