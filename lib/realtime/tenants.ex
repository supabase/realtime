defmodule Realtime.Tenants do
  ...
  @spec authorizations_per_second_rate(Tenant.t()) :: RateCounter.Args.t()
  def authorizations_per_second_rate(%Tenant{external_id: external_id} = tenant) do
    opts = [
      max_bucket_len: 30,
      limit: [
        ...
        measurement: :sum,
        log_fn: fn ->
          Logger.critical("UnableToSetPolicies: Too many database timeouts",
