  ...
  def start(_type, _args) do
    ...
    children =
      [
        ...
        {Phoenix.PubSub, name: Realtime.PubSub, pool_size: 10, adapter: Realtime.PubSubAdapter.PG},
        {Cachex, name: Realtime.RateCounter},
        Realtime.PubSubAdapter.CachexSupervisor,
        Realtime.PubSubAdapter.TenantGroupRefresher,
