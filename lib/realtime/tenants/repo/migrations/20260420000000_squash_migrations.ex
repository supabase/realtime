defmodule Realtime.Tenants.Migrations.SquashMigrations do
  ...
  defp create_table_dependent_functions do
    ...
    execute("DROP FUNCTION IF EXISTS realtime.list_changes(name, name, integer, integer)")
  ...
  defp configure_identity do
    ...
    BEGIN
        IF NOT EXISTS (
            ...
            WHERE c.relkind = 'S' AND c.relname = 'subscription_id_seq' AND n.nspname = 'realtime'
        ) THEN
