defmodule Multiplayer.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule MultiplayerWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Multiplayer.PromEx
  ...
  use PromEx, otp_app: :multiplayer
  ...
  def plugins do
    [
      ...
      # Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: MultiplayerWeb.Router},
      # Plugins.Ecto,
      # Plugins.Oban,
      # Plugins.PhoenixLiveView
      Multiplayer.PromEx.Plugins.Channels
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:multiplayer, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
