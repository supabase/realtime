...
/**
 * Supabase Realtime does not support JSONB expression filters (e.g. data->>organization_id).
 * Use a dedicated scalar column instead and filter by direct equality.
 */
