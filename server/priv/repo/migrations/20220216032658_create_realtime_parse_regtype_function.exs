defmodule Realtime.RLS.Repo.Migrations.CreateRealtimeParseRegtypeFunction do
  use Ecto.Migration

  def change do
    execute "create or replace function realtime.parse_regtype(text)
      returns regtype
      immutable
      language sql
  ...
  execute "create or replace function realtime.is_visible_through_filters(columns realtime.wal_column[], filters realtime.user_defined_filter[])
    returns bool
    language sql
    immutable
  as $$
